...
// Se registra un factory con la variable factories que se creo en el archivo "app.js"
factories.factory("CiudadFactory", ['$resource', 'CONSTANTES_GLOBALES', ciudadFactory]);

function ciudadFactory($resource, CONSTANTES_GLOBALES) {

	return $resource (
						// url
						CONSTANTES_GLOBALES.REST_CIUDAD + ':action',
						// paramDefaults, 
						{},
						// Actions
						{
