 ...
 * @author Usuario
 */
public class DetalleFacturaRest implements EntidadBaseRest, Serializable {
	...
	public DetalleFacturaRest(Long idDetalle) {
	...
	public FacturaRest getIdFactura() {
		return idFactura;
	}

	public void setIdFactura(FacturaRest idFactura) {
	...
	public boolean equals(Object object) {
		...
		// not set
		if (!(object instanceof DetalleFacturaRest)) {
			return false;
		}
		DetalleFacturaRest other = (DetalleFacturaRest) object;
